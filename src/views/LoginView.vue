        ...
        <div
            ...
            <el-form :model="form" size="normal" style="height: 100% ;width: 220px;" ref="form" :rules="rules">
                ...
                <el-form-item prop="userpwd">
                    <el-input v-model="form.userpwd" prefix-icon="el-icon-lock" placeholder="请输入密码" show-password>
                    </el-input>
                </el-form-item>
                <el-form-item>
                    <el-button
                ...
                <el-form-item style="text-align: center; color: white;">
                    <a @click="toRegister"
                        style="font-size: 16px;font-weight: 500;opacity: 0.8;text-decoration: underline">注册</a>
                </el-form-item>
            </el-form>
        </div>
    </div>
    ...
    methods: {
        ...
        login() {
            this.$refs['form'].validate((valid) => {
                if (valid) {
                    var url = "/api/user/UserLogin?username=" + this.form.username + "&userpwd=" + this.form.userpwd
